...
export const speed_data = [
    { value: 'm/s', text: 'metros por segundo' },
    { value: 'km/s', text: 'quilômetros por segundo' },
    { value: 'cm/s', text: 'centímetros por segundo' },
    { value: 'mm/s', text: 'milímetros por segundo' },
    { value: 'km/h', text: 'quilômetros por hora' },
    { value: 'm/h', text: 'metros por hora' },
    { value: 'mi/h', text: 'milhas por hora (mph)' },
    { value: 'ft/s', text: 'pés por segundo' },
    { value: 'ft/min', text: 'pés por minuto' },
    { value: 'knot', text: 'nós (nautical mile per hour)' },
    { value: 'c', text: 'velocidade da luz no vácuo' },
    { value: 'mach', text: 'mach (velocidade do som)' }
];